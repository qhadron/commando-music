...
function sendNowPlaying(channel, song) {
	sendSongInfo(channel, 'Now playing...', song);
}
...
module.exports = {
	...
	formatTextChannelName: x => config.formatTextChannelName(escapeDiscord(x)),
	formatVoiceChannelName: x => config.formatVoiceChannelName(escapeDiscord(x)),
